      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-0">
        ...
        <form className="mt-12">
                ...
                <li key={image.id} className="flex py-6">
                  ...
                  <div className="ml-4 flex flex-1 flex-col sm:ml-6">
                    ...
                    <div className="mt-4 flex flex-1 items-end justify-between">
                      <div className="ml-4">
                        <button type="button" onClick={() => {deleteImageById(image.id)}} className="flex flex-row justify-evenly items-center gap-x-2 text-sm border border-gray-300 hover:border-red-500 px-3 py-2 rounded-lg font-medium text-black hover:text-red-500">
                          <span>Delete</span>
          ...
          <section aria-labelledby="summary-heading" className="mt-10">
            <div className="mt-10">
              <div
                className="w-full rounded-md border border-transparent text-center bg-gray-800 px-4 py-3 text-base font-medium text-white shadow-sm focus:outline-none hover:bg-black focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"
              >
                No Images
              </div>
            </div>
